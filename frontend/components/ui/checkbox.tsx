...
function Checkbox({
  ...
  const checkboxId = id || (ariaLabel ? `checkbox-${ariaLabel}` : undefined)
  ...
  if (ariaLabel) {
    return (
      <label
        htmlFor={checkboxId}
        className="inline-flex items-center gap-1.5 cursor-pointer select-none has-[:disabled]:cursor-not-allowed has-[:disabled]:opacity-50">
        {checkbox}
